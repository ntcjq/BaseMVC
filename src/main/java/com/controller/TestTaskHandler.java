 ...
 *
 */
public class TestTaskHandler extends JbpmTestCase implements JbpmUtil{

	@Override
	public void deploy() {
		super.setUp();
		repositoryService.createDeployment().addResourceFromClasspath("jpdl/taskHandler.jpdl.xml").deploy();
	}
	...
	public void createInstance() {
		...
		map.put("user", user);
		//创建流程 同时 新增流程变量
		ProcessInstance processInstance = executionService.startProcessInstanceByKey("taskHandler",map);
	...
	@Override
	public void getTask() {
		List<Task> tasks = taskService.findPersonalTasks("userA");
