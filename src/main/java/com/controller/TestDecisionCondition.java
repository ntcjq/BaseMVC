 ...
 *
 */
public class TestDecisionCondition extends JbpmTestCase implements JbpmUtil{

	@Override
	public void deploy() {
		super.setUp();
		repositoryService.createDeployment().addResourceFromClasspath("jpdl/decisionCondition.jpdl.xml").deploy();
	}
	...
	public void createInstance() {
		...
		map.put("days", "2");//选择去哪个节点
		//创建流程 同时 新增流程变量
		ProcessInstance processInstance = executionService.startProcessInstanceByKey("decisionCondition",map);
