 ...
 *
 */
public class TestEl extends JbpmTestCase implements JbpmUtil{

	@Override
	public void deploy() {
		super.setUp();
		repositoryService.createDeployment().addResourceFromClasspath("jpdl/el.jpdl.xml").deploy();
	}
	...
	public void createInstance() {
		...
		map.put("projectManager", "cjq");
		map.put("deptManager", "gyn");
		//创建流程 同时 新增流程变量
		ProcessInstance processInstance = executionService.startProcessInstanceByKey("el",map);
	...
	@Override
	public void getTask() {
		List<Task> tasks = taskService.findPersonalTasks("gyn");
	...
	public void completeTask() {
		// TODO Auto-generated method stub
		taskService.completeTask("120004");
	}
	//新增任务变量
